...
with col5:
    ...
    fig5.update_layout(height=320, margin=dict(t=40,b=20),
                       xaxis_title="Hour (24h)", yaxis_title="Clicks", showlegend=False,
                       plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='rgba(0,0,0,0)')
...
with col6:
    ...
    if len(conv_hour) > 0:
        ...
        fig6.update_layout(height=320, margin=dict(t=40,b=20),
                           xaxis_title="Hour (24h)", yaxis_title="Conversions", showlegend=False,
                           plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='rgba(0,0,0,0)')
...
# --- TIME SUMMARY (no cost_usd — removed due to 8x inflation bug in view) ---
